...
public class NBTUtils {
    ...
    private static void handleTag(int currentIndentation, int indentationLevel, boolean colors, StringBuilder result,
            NbtElement tag) {
        if (tag instanceof NbtCompound) {
            result.append(
                    formatNBT((NbtCompound) tag, currentIndentation + indentationLevel, indentationLevel, colors));
