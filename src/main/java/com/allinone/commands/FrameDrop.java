    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        builder.executes(context -> {
            if (mc.player == null || mc.world == null || mc.interactionManager == null)
                return 0;
            List<ItemFrameEntity> itemFrames = mc.world.getEntitiesByClass(ItemFrameEntity.class,
                    mc.player.getBoundingBox().expand(4), entity -> entity.getHeldItemStack().getItem() != Items.AIR);
