...
import com.allinone.nbt.CrashBeehive;
import com.allinone.nbt.GrieferKit;
import com.allinone.nbt.SpawnerKit;

import static com.mojang.brigadier.Command.SINGLE_SUCCESS;
import static meteordevelopment.meteorclient.MeteorClient.mc;
import static com.allinone.util.give;
...
public class GetNbtItem extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(literal("CrashHive").executes(ctx -> {
            ...
            if (!mc.player.getAbilities().creativeMode) {
                error("You need to be in creative mode to use this command");
            }
