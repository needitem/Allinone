...
public class SeedMap extends Module {
    ...
    private final Setting<Integer> serverPort = sgGeneral.add(new IntSetting.Builder()
            .name("port")
            .description(
                    "The port used for connections, your minecraft instance must be able to accept incoming connections on this port.")
            .defaultValue(8080)
            .range(1, 65535)
            .noSlider()
            .build());
    ...
    private void onTick(TickEvent.Post event) {
        if (webSocket == null || mc.player == null || mc.world == null)
            return;
