...
public class WordFilterModule extends Module {
    public WordFilterModule() {
        super(Addon.CATEGORY, "word-filter", "Filters words you send in the chat to prevent getting banned");
    }
     ...
     * return;
     * }
     * /* ChatMessageC2SPacket packet = new ChatMessageC2SPacket(new
     * PacketByteBuf(Unpooled.buffer()).writeString(message.trim())); // wtf is
     * this??
     * mc.player.networkHandler.sendPacket(packet); // I took this shit from meteor
     * client
