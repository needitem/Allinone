...
import com.allinone.utils.JinxUtils;
import com.allinone.utils.Utils;
    ...
    private void onTick(TickEvent.Pre event) {
        for (Entity entity : mc.world.getEntities()) {
            if (entity instanceof ItemEntity) {
                ...
                if (!Utils.isABFree(mc.player.getPos(), entity.getPos()))
                    return;
                mc.player.networkHandler.sendPacket(
                        new PlayerMoveC2SPacket.PositionAndOnGround(entity.getX(), entity.getY(), entity.getZ(), true));
            }
        }
    }
}